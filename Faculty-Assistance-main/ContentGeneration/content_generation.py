...
def content_gen():
    ...
    with col1:
        ...
        st.markdown("")
    with col2:
        vAR_Model = st.selectbox("",["Select","GPT-3","GPT-3.5 Turbo Model"])
        if vAR_Model != "Select":
            with col1:
            ...
            if vAR_Model == "GPT-3":
                ...
                vAR_topics_list = ["Give 20 to 30 subtopics for" + "'"+vAR_prompt_file+"'"+" from basics"]
            ...
            if vAR_Model =="GPT-3.5 Turbo Model":
                with col2:
                    if vAR_prompt_file !="":
                        st.markdown("")
                        button_placeholder = st.empty()
